 ...
 * `domain/portalSync.ts` / `adapters/driven/portalSyncIo.ts`.
 */
...
} from '../../../application/portalReplicaStore';
import { syncPortalReplica, type PortalSyncSummary } from '../../driven/portalSyncIo';
import { defaultPortalRunStorage, loadPortalRun } from '../../../application/runPortal';
import { shortenAddress } from '../../../shared/share';
