...
const pairs = [
  ...
  { rust: ['crates/social-format/src/attach.rs', 'MAX_BLOB_PART_BYTES'], web: ['web/src/social/blobUpload.ts', 'BLOB_PART_BYTES'], what: 'attachment upload chunk size' },
  { rust: ['crates/social-format/src/attach.rs', 'MAX_BLOB_PARTS'], web: ['web/src/social/blobUpload.ts', 'BLOB_MAX_PARTS'], what: 'attachment upload chunk count' },
